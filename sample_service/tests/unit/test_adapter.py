...
from harmony_sample_service.adapter import SampleServiceAdapter, ZarrException


class TestSampleServiceAdapter(TestCase):
    """ Unit tests for methods in the `SampleServiceAdapter` class. These tests
    ...
    @patch.object(SampleServiceAdapter, 'process_items_many_to_one')
    def test_invoke_single_input(self, mock_process_items,
        ...
        harmony_adapter = SampleServiceAdapter(harmony_message,
